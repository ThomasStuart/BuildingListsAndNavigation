...
extension LandmarkRow_Previews {
    @_dynamicReplacement(for: previews) private static var __preview__previews: some View {
        ...
        AnyView(__designTimeSelection(LandmarkRow(landmark: __designTimeSelection(landmarkData[__designTimeInteger("#6363.[2].[0].property.[0].[0].arg[0].value.[0].value", fallback: 0)], "#6363.[2].[0].property.[0].[0].arg[0].value")), "#6363.[2].[0].property.[0].[0]"))
#sourceLocation()
    }
}
